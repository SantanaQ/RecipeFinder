...
public class RecipeConfig {
    ...
    CommandLineRunner commandLineRunner(IngredientRepository ingredientRepository,
        ...
        return args -> {
            ...
            Tag italian = tagService.saveTag(new Tag("Italian"));
            Tag pasta = tagService.saveTag(new Tag("Pasta"));
            Tag quick = tagService.saveTag(new Tag("Quick"));
            ...
            List<RecipeTag> carbonaraTags = new ArrayList<>();
            carbonaraTags.add(new RecipeTag(carbonara, italian));
            carbonaraTags.add(new RecipeTag(carbonara, pasta));
            carbonaraTags.add(new RecipeTag(carbonara, quick));

            recipeTagRepository.saveAll(carbonaraTags);
            ...
            Tag indian = tagService.saveTag(new Tag("indian"));
            Tag spicy = tagService.saveTag(new Tag("spicy"));
            Tag creamy = tagService.saveTag(new Tag("creamy"));

            List<RecipeTag> curryTags = new ArrayList<>();
            curryTags.add(new RecipeTag(chickenCurry, indian));
            curryTags.add(new RecipeTag(chickenCurry, spicy));
            curryTags.add(new RecipeTag(chickenCurry, creamy));
            recipeTagRepository.saveAll(curryTags);
